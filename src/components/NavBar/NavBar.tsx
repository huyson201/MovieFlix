        ...
        <header className={classnames('header py-3 absolute top-0 left-0 w-full z-10', { 'bg-black': navDark })}>
            <Wrapper className='flex flex-row  items-center'>
                ...
                <nav className={classnames('menu', { active: showNav })}>
                    ...
                    <NavLink to={"/"} className={({ isActive }) => classnames("menu-items", { active: isActive })}>Home</NavLink>
                    <NavLink to={"/movies"} className={({ isActive }) => classnames("menu-items", { active: isActive })}>Movies</NavLink>
                    <NavLink to={"/tv-series"} className={({ isActive }) => classnames("menu-items", { active: isActive })}>TV-Series</NavLink>
                </nav>
